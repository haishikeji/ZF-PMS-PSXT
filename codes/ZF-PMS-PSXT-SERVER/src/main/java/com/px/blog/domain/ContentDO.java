...
public class ContentDO implements Serializable {
	 ...
	 * 设置：创建时间
	 */
	public void setGtdeclarereate(Date gtdeclarereate) {
		this.gtdeclarereate = gtdeclarereate;
	}
	/**
	 * 获取：创建时间
	 */
	public Date getGtdeclarereate() {
		return gtdeclarereate;
	}
	/**
	 * 设置：修改时间
	 */
